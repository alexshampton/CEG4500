...
function init() {
    ...
    gl.uniformMatrix2fv(MUniform, MJS);
...
function render() {
    ...
    thetaJS = thetaJS + 0.05;

    MJS = [Math.cos(thetaJS), -Math.sin(thetaJS), Math.sin(thetaJS), Math.cos(thetaJS)];
    gl.uniformMatrix2fv(MUniform, M);
